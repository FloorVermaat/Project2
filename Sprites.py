...
class StoryPlanet(pg.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pg.image.load(os.path.join(img_folder, "story planet.png")).convert_alpha()
        self.image_orig = self.image.copy()
        self.rect = self.image.get_rect()
        self.mask = pygame.mask.from_surface(self.image)
        self.rect.x = W / 2
...
class BlackHolePlanet(pg.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pg.image.load(os.path.join(img_folder, "Blackhole.png")).convert_alpha()
        self.image_orig = self.image.copy()
        self.rect = self.image.get_rect()
        self.mask = pygame.mask.from_surface(self.image)
        self.rect.x = W - 90
